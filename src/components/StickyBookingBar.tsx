...
const StickyBookingBar = () => {
  ...
  return (
    <>
      ...
      <div 
        className="hidden md:block fixed top-[128px] left-0 right-0 z-40 bg-[#2E8B57] text-white shadow-lg"
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-2 bg-white text-[#2E8B57] font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200"
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-[#2E8B57] text-white shadow-lg">
        <div className="px-4 py-4">
          <div className="text-center mb-3">
            <span className="text-sm font-semibold">
              📅 Réservez votre consultation nutritionnelle
            </span>
          </div>
          <button
            onClick={scrollToCabinets}
            className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 bg-white text-[#2E8B57] font-semibold rounded-lg hover:bg-gray-50 transition-colors duration-200 min-h-[52px]"
            aria-label="Choisir votre cabinet pour réserver votre consultation"
          >
