      ...
      <div className="container mx-auto px-5">
              <div className="max-w-5xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8" style={{ alignItems: 'stretch' }}>
                  {/* Independence Card */}
                  <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-green-200 hover:shadow-xl transition-shadow duration-300 flex flex-col h-full">
                  ...
                  {/* Science-Based Card */}
                  <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-blue-200 hover:shadow-xl transition-shadow duration-300 flex flex-col h-full">
                    <div className="flex items-center gap-3 mb-4">
